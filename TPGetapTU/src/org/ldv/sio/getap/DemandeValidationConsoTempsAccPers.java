...
public class DemandeValidationConsoTempsAccPers {
	...
	public boolean demandeAccepteEleveApresModifProf() {
		boolean demandeAccepteeEleve = (this.etat & DVCTAP_ACCEPTEE_MODIF_PROF) != 0;
		return demandeAccepteeEleve;
	}
	...
	public boolean demandeModifParEleve() {
		boolean demandeModifEleve = (this.etat & DVCTAP_MODIFIEE_ELEVE) != 0;
		return demandeModifEleve;
	}

	public boolean demandeAnnuleeEleve() {
		boolean demandeAnnuleeEleve = (this.etat & DVCTAP_ANNULEE_ELEVE) != 0;
		return demandeAnnuleeEleve;
	}

	public boolean demandeValideParProf() {
		boolean demandeValideProf = (this.etat & DVCTAP_VALIDEE_PROF) != 0;
		return demandeValideProf;
	}

	public boolean demandeRefuseParProf() {
		boolean demandeRefusProf = (this.etat & DVCTAP_REFUS_PROF) != 0;
		return demandeRefusProf;
	}
